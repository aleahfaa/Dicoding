"""
https://www.dicoding.com/academies/86/tutorials/32530
TODO:
...
# madebyiffa(077)
panjang = len(var_list) #list length
maksimal = max(var_list) #list max
minimal = min(var_list) #list min
banyak = var_list.count(605132) #count how many 605132 in list